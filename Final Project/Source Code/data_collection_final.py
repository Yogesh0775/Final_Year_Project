...
count = len(oss.listdir("E:/7 sem project\American-sign-Language/Final Project/Source Code/AtoZ_3.1"))
c_dir = 'A'
    ...
    try:
        ...
        if interrupt & 0xFF == ord('n'):
            ...
            if ord(c_dir)==ord('Z')+1:
                c_dir='A'
            flag = False
            count = len(oss.listdir("E:/7 sem project\American-sign-Language/Final Project/Source Code/AtoZ_3.1" + (c_dir) + "\\"))
        ...
        if flag==True:
            ...
            if suv==180:
                flag=False
            if step%3==0:
                cv2.imwrite("D:\\ASL\\Sign-Language-To-Text-and-Speech-Conversion\\AtoZ_3.2" + (c_dir) + "\\" + str(count) + ".jpg",
                            skeleton1)
