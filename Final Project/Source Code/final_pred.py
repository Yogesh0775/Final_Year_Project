...
class Application:
    ...
    def __init__(self):
        ...
        self.root = tk.Tk()
        self.root.title("American Sign Language Recognition System")
        ...
        self.T.config(text="American Sign Language Recognition System", font=("Times New Roman", 40, "bold"))
        self.T.config(bg="#FDF7E4",fg="#BBAB8C")
